...
?>
    ...
    <tr>
        <td height="60"><div align="center"><font face="Arial" size="4"><b>Gerenciamento de Clientes - BIL</b></font></div></td>
    </tr>
    </table><br>
<?php
     //A formatação do campo cliDtInclusao, para retornar a data no formato dd/MM/yyyy
     $sqlCliente = mysqli_query($conexao,"SELECT cliID, date_format(cliDtInclusao,'%d/%m/%Y') as cliDtInclusao, cliNome, cliEndereco, cliBairro, cliEmail, cliTel, cliCidade, cliUF FROM clientes".
...
?>
    ...
    <a href='menuGerClientes.php'><b>Voltar para o menu de Opções Gerenciamento de Clientes</a><br>
